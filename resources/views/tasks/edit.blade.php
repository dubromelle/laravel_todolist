    ...
    <x-tasks-card>
        ...
        <form action="{{ route('tasks.update', $task->id) }}" method="post">
            ...
            <div class="block mt-4">
                ...
                <input id="state" type="checkbox" class="rounded border-gray-300 text-indigo-600 shadow-sm focus:border-indigo-300 
                    focus:ring focus:ring-indigo-200 focus:ring-opacity-50" name="state" @if(old('state', $task->state)) checked @endif>
